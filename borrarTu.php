<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $consulta = "delete from tutelas where tutor='$tutor' and tutelado='$alumno'";
        // $inserta_and = false;
        // $todos = true;
        // if ($nombre != "") {
...
echo $consulta;
        if ($resultado) {
            echo json_encode(array("resultado"=>"Tutela borrada"));
        } else {
            echo json_encode(array("resultado"=>"Tutela no borrada"));
        }
